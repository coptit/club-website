...
let contest_date = new Date("feb 25, 2023 10:50:00").getTime();
...
let E = setInterval(()=>{
    ...
    if ((days<=0) && (hrs <= 0) && (mins <=0) && (secs <= 0)){
        document.getElementsByClassName("event-desc")[0].innerHTML= "Event registrations closed";
        reg_close();
        clearInterval(E);
    }
    else {
        document.getElementById("event1-in").innerHTML= days+"d : "+hrs+"h : "+mins+"m : "+secs+"s";
    }
}, 1000);